...
def main():
    PATH_TO_LEETCODE_DATA = path.expanduser(
        "~/.config/eww/data/leetcode_today_problem.json"
    )
...
def get_leetcode_today_json() -> str:
    ...
    if request.status_code == 200:
        ...
        format_dict["color"] = (
            "#a3be8c"
            if format_dict["difficulty"] == "Easy"
            else ("#ebcb8b" if format_dict["difficulty"] == "Medium" else "#bf616a")
        )
        format_dict["tags"] = []
